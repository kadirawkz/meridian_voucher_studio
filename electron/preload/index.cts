...
const api: AppApi = {
  ...
  updateProfile: (updates: { employeeName?: string; employeeEmail?: string }) =>
    ipcRenderer.invoke("auth:update-profile", updates),
  saveVoucher: (voucher: VoucherPayload) =>
    ipcRenderer.invoke("voucher:save", voucher),
  generateDocuments: (voucher: VoucherPayload) =>
    ipcRenderer.invoke("voucher:generate", { voucher, format: "pdf" }),
  generateDocx: (voucher: VoucherPayload, customOutputDir?: string) =>
    ipcRenderer.invoke("voucher:generate", {
      voucher,
      format: "docx",
      customOutputDir,
    }),
  generatePdf: (voucher: VoucherPayload, customOutputDir?: string) =>
    ipcRenderer.invoke("voucher:generate", {
      voucher,
      format: "pdf",
      customOutputDir,
  ...
  listVouchers: (filters?: VoucherListFilters) =>
    ipcRenderer.invoke("vouchers:list", filters),
  getVoucher: (voucherId: string) =>
    ipcRenderer.invoke("voucher:get", voucherId),
  listVoucherRevisions: (voucherId: string) =>
    ipcRenderer.invoke("voucher:revisions", voucherId),
  updateVoucherStatus: (voucherId: string, status: VoucherStatus) =>
    ipcRenderer.invoke("voucher:status", { voucherId, status }),
  ...
  deleteHotelRate: (hotelRateId: string) =>
    ipcRenderer.invoke("rate-master:delete", hotelRateId),
  listInactiveHotelRates: () => ipcRenderer.invoke("rate-master:list-inactive"),
  restoreHotelRate: (hotelRateId: string) =>
    ipcRenderer.invoke("rate-master:restore", hotelRateId),
  listHotelRates: (hotelName?: string) =>
    ipcRenderer.invoke("rate-master:list", hotelName),
  ...
  saveTourType: (ref: { code: string; name: string }) =>
    ipcRenderer.invoke("reference:save-tour-type", ref),
  deleteTourType: (id: string) =>
    ipcRenderer.invoke("reference:delete-tour-type", id),
  listMealBasis: () => ipcRenderer.invoke("reference:meal-basis"),
  saveMealBasis: (ref: { code: string; name: string }) =>
    ipcRenderer.invoke("reference:save-meal-basis", ref),
  deleteMealBasis: (id: string) =>
    ipcRenderer.invoke("reference:delete-meal-basis", id),
  saveMarket: (ref: { code: string; name: string }) =>
    ipcRenderer.invoke("reference:save-market", ref),
  deleteMarket: (id: string) =>
    ipcRenderer.invoke("reference:delete-market", id),
  saveCustomer: (ref: { name: string; is_active?: boolean }) =>
    ipcRenderer.invoke("reference:save-customer", ref),
  deleteCustomer: (id: string) =>
    ipcRenderer.invoke("reference:delete-customer", id),
  saveRoomCategory: (ref: { name: string }) =>
    ipcRenderer.invoke("reference:save-room-category", ref),
  deleteRoomCategory: (id: string) =>
    ipcRenderer.invoke("reference:delete-room-category", id),
  listCurrencies: () => ipcRenderer.invoke("reference:currencies"),
  saveCurrency: (ref: { code: string; name: string }) =>
    ipcRenderer.invoke("reference:save-currency", ref),
  deleteCurrency: (id: string) =>
    ipcRenderer.invoke("reference:delete-currency", id),
  listInactiveReferences: (table: string) =>
    ipcRenderer.invoke("reference:list-inactive", table),
  restoreReference: (table: string, id: string) =>
    ipcRenderer.invoke("reference:restore", { table, id }),
  autoFillVoucher: (voucher: VoucherPayload, contractId?: string) =>
    ipcRenderer.invoke("rate-master:auto-fill", { voucher, contractId }),
  ...
  revealInExplorer: (filePath: string) =>
    ipcRenderer.invoke("tours-folder:reveal", filePath),
